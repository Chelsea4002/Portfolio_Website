  ...
  return (
    <>
      {/* <div className="relative h-full">
        ...
        <div className="bg-white max-w-[95%] lg:max-w-[100%] h-auto lg:h-[625px] rounded-3xl relative mx-auto p-6 lg:p-10 flex flex-col lg:flex-row">
          <div className="flex justify-center lg:justify-start mb-6 lg:mb-0">
            <Image
              ...
              className="rounded-full w-[180px] h-[180px] lg:w-[300px] lg:h-[300px] object-cover"
            />
          </div>
          <div className="flex flex-col justify-center lg:-ml-10">
            <div className="text-[13px] lg:text-[20px] mb-4">
              I am Chelsea Cho, an entry-level web developer candidate from Toronto, Canada.
            </div>
            <button 
              className="font-semibold text-white bg-[#6497D6] hover:bg-slate-300 hover:text-[#6497D6] 
              rounded-3xl text-[18px] lg:text-[30px] w-[310px] h-[30px] lg:ml-[18px] lg:mt-5 lg:w-[1180px] lg:h-[45px]"
            >
              Download CV
            </button>
          </div>
